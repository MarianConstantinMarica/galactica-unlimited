            ...
            <MDBRow>
                <MDBCol sm='4' style={{ backgroundColor: '#006989' }}>
                    ...
                    <div className='d-flex flex-column justify-content-center h-custom-2 w-75 pt-4'>
                        ...
                        <button className="mb-3 px-5 mx-5 w-100" size='md' style={{ backgroundColor: '#edff7a', color: 'black', borderRadius: 7}} onClick={login}>LOG IN</button>
                        <button className="mb-5 px-5 mx-5 w-100" size='md' style={{ backgroundColor: 'transparent', borderColor: '#00ffe7', color: '#00ffe7', borderRadius: 7 }} onClick={register}>CREATE ACCOUNT</button>
                    </div>
                </MDBCol>
            </MDBRow>
        </MDBContainer>
